  ...
  return (
    <ManualSection
      ...
      steps={[
        ...
        { title: "Klik FortiGate toevoegen", body: "Vul management URL, HTTPS-poort, API-token en planning in. TLS staat altijd aan; geldige, self-signed en ongeldige certificaten worden automatisch geaccepteerd.", result: "De firewall wordt aan deze klant gekoppeld." },
