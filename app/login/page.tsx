...
export default async function LoginPage() {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-background px-4 py-10">
      <section className="security-panel professional-surface w-full max-w-[420px] overflow-hidden rounded-md border border-border shadow-xl shadow-slate-900/10 dark:shadow-black/30">
