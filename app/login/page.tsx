  ...
  return (
    <main className="grid min-h-screen bg-background lg:grid-cols-[minmax(0,1.1fr)_minmax(28rem,.9fr)]">
      <section className="relative hidden overflow-hidden bg-[hsl(var(--header))] p-12 text-[hsl(var(--header-foreground))] lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3"><span className="brand-sigil" aria-hidden="true"><span /></span><span><span className="block text-sm font-bold tracking-[0.28em]">FORTI</span><span className="block text-sm font-bold tracking-[0.28em]">VAULT</span></span></div>
      ...
      <section className="grid place-items-center px-4 py-10 sm:px-8">
        <div className="w-full max-w-[430px]">
          <div className="mb-10 flex items-center gap-3 lg:hidden"><span className="brand-sigil brand-sigil-small" aria-hidden="true"><span /></span><span className="text-xs font-bold tracking-[0.18em]">FORTI VAULT</span></div>
