...
TLS is voor iedere FortiGate-verbinding verplicht. Geldige, self-signed, verlopen en anderszins ongeldige certificaten worden automatisch geaccepteerd, ook na een certificaatwissel. De verbinding blijft versleuteld, maar het portaal verifieert de identiteit van de FortiGate daardoor niet via PKI of een vastgezette fingerprint.
